...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/home/yulun/data/DN/RGB/npy',
...
parser.add_argument('--testpath', type=str, default='/media/yulun/10THD1/testdata/Denoising/LQ',
